          ...
          {({ handleChange, handleSubmit, values, setFieldValue, errors, touched, isValid }) => (
            <View style={styles.formWrapper}>
              ...
              <View style={styles.wrapper}>
                ...
                <TouchableOpacity
                  style={[styles.inputWrapper, { borderColor: touched.category ? '#2D388A' : '#ccc' }]}
                  onPress={() => setModalVisible(true)}
                >
                  <Ionicons name="list" size={20} color="black" style={styles.iconStyle} />
                  <Text style={{ flex: 1, color: selectedCategory ? 'black' : '#ccc' }}>
              ...
              <View style={styles.wrapper}>
                ...
                <TouchableOpacity
                  style={[styles.inputWrapper, { borderColor: touched.icon ? '#2D388A' : '#ccc' }]}
                  onPress={() => setIconModalVisible(true)}
                >
                  <Ionicons name={selectedIcon || 'add'} size={24} color="black" style={styles.iconStyle} />
                  <Text style={{ flex: 1, color: selectedIcon ? 'black' : '#ccc' }}>
                    {selectedIcon || 'Selecione um ícone'}
                  </Text>
                </TouchableOpacity>
                    ...
                    <FlatList
                      ...
                      renderItem={({ item }) => (
                        <TouchableOpacity
                          ...
                          onPress={() => handleIconSelect(item, setFieldValue)}
                        >
                          <Ionicons name={item} size={24} color="black" />
                        </TouchableOpacity>
                      )}
                    />
                    <TouchableOpacity onPress={() => setIconModalVisible(false)} style={styles.modalCloseButton}>
                      <Text style={styles.modalCloseText}>Fechar</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              ...
              <View style={styles.wrapper}>
                ...
                >
                  ...
                  <Text style={{ flex: 1, color: values.img ? 'black' : '#ccc' }}>
                    {values.img ? 'Imagem selecionada' : 'Escolha uma imagem'}
                  </Text>
                </TouchableOpacity>
                {image && (
